...
//        Image canguruImg = new Image(canguru);
//        Image elefanteImg = new Image(elefante);
//        Image cacatuaImg = new Image(cacatua);
//        Image periquitoImg = new Image(periquito);
...
//        animais.add(new Animal("Canguru.", "Macropus giganteus.", "Se alimenta de frutas e vegetais.", "Vive em média 18 anos.", "Os cangurus têm tendência para preferir a mão esquerda à direita quando realizam tarefas, seja para se alimentarem, limparem ou se apoiarem.", new ImageView(canguruImg)));
//        animais.add(new Animal("Elefante-marinho.", "Mirounga spp.", "Se alimenta de lulas, sépias, pequenos crustáceos, polvos e raias.", "Vive em média 20 anos.", "Os elefantes-marinhos passam cerca de 80% das suas vidas a nadar nos oceanos, podem ficar até 80 minutos sem respirar e mergulhar até aos 1700 metros de profundidade.", new ImageView(elefanteImg)));
//        animais.add(new Animal("Cacatua.", "Cacatuidae.", "Se alimenta de vegetais, sementes, grãos e castanhas.", "Vive em média 30 a 80 anos.", "Imitadora da fala humana, capaz de fazer acrobacias e se afeiçoar às pessoas, além de elegante e vistosa, esta ave vem conquistando espaço como companheira de estimação. ", new ImageView(cacatuaImg)));
//        animais.add(new Animal("Periquito-australiano.", "Melopsittacus undulatus.", "Se alimenta de sementes.", "Vive em média 5 a 10 anos em cativeiro.", "Os pontos pretos na garganta do periquito são capazes de refletir raios UV e podem ser usados para distinguir as aves entre si.", new ImageView(periquitoImg)));
//        animais.add(new Animal("Equidna.", "Tachyglossidae.", "Se alimenta de insetos e vermes.", "Vive em média 50 anos em cativeiro.", "A equidna consegue escavar grandes buracos (tocas) em um tempo muito curto, cerca de 2 a 3 minutos.", new ImageView(equidnaImg)));
//        animais.add(new Animal("Ornitorrinco.", "Ornithorhynchus anatinus.", "Carnívoros, se alimenta de anelídeos, larvas de insetos aquáticos, camarões de água doce, girinos, caramujos, lagostins de água doce e pequenos peixes.", "Vive em média 17 anos em cativeiro.", "O ornitorrinco não tem estômago.", new ImageView(ornitorrincoImg)));
//        animais.add(new Animal("Vombate.", "Vombatidae.", "Se alimenta de gramíneas, ciperáceas, ervas, cascas de árvores e raízes.", "Vive em média 15 anos.", "Os vombates cavam sistemas de tocas e túneis com seus dentes incisivos semelhantes aos dos roedores e com suas poderosas garras.", new ImageView(vombateImg)));
//    }
//
//}
