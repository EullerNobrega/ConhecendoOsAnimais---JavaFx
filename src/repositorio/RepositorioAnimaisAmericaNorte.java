...
//        Image cobraImg = new Image(cobra);
        ...
        animaisANorte.add(new Animal("Alce.", "Alces alces.", "Herbívoro, se alimenta de vegetais e frutas.", "Vive em média 15 a 25 anos.", "Os alces têm pernas longas e pescoço curto, o que os impede de pastar das ervas rasteiras.", new ImageView(alceImg)));
