...
public class RepositorioAnimaisAmericaNorte extends AbstractRepositorio {
    ...
    public void init() {
        ...
        animais.add(new Animal("Onça-parda.", "Puma concolor.", "- Apesar de se alimentar muitas vezes de ungulados terrestres, a onça-parda pode se alimentar de animais arborícolas, principalmente de primatas de porte médio, como bugios e macacos-aranhas.", "Vive em média 8 a 13 anos na natureza.", "É um animal solitário e mais ativo à noite.", new ImageView(oncaImg)));
        animais.add(new Animal("Alce.", "Alces alces.", "Herbívoro, se alimenta de vegetais e frutas.", "Vive em média 15 a 25 anos.", "Os alces têm pernas longas e pescoço curto, o que os impede de pastar das ervas rasteiras.", new ImageView(alceImg)));
        animais.add(new Animal("Lince.", "Lynx.", "Carnívoro, sua principal presa é a lebre, mas também se alimenta de roedores, lagomorfos e cervos.", "Vive em média 7 anos.", "Os recém-nascidos são cegos e surdos, com uma camada de pêlos fina. Permanecem com a mãe durante um ano.", new ImageView(linceImg)));
        animais.add(new Animal("Guaxinim.", "Procyon lotor.", "Se alimenta de plantas, roedores, anfíbios, ovos, frutas e sementes.", "Vive em média 2 a 3 anos na natureza.", "Geralmente se aproximam dos leitos dos rios para comer e se lavar, por isso são conhecidos como ursos lavadores.", new ImageView(guaxinimImg)));
        animais.add(new Animal("Gambá.", "Didelphis.", "Se alimenta de raízes, frutas, vermes, insetos, moluscos, crustáceos, anfíbios, entre outros.", "Vive em média 2 a 4 anos.", "Alguns gambás são imunes ao veneno de serpentes, podendo atacá-las pela cabeça e ingeri-las.", new ImageView(gambaImg)));
        ...
        animais.add(new Animal("Doninha-anã.", "Mustela.", "Se alimenta de roedores, coelhos e outros pequenos mamíferos.", "Vive em média 4 a 6 anos.", "No inverno, a doninha troca a sua pelagem e fica inteiramente branca para se camuflar na neve.", new ImageView(doninhaImg)));
    }
